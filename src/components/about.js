...
export default function About() {
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20" id="Hakkında">
      ...
      <div className="grid gap-8 row-gap-0 lg:grid-cols-3">
        <div className="relative text-center">
          ...
          <p className="max-w-md mb-3 text-sm text-gray-500 sm:mx-auto">
            Bak fena vurucu palamar fare ana yelken su alabora olabilir,
            babuna çak.
          </p>
        </div>
        <div className="relative text-center">
          ...
          <p className="max-w-md mb-3 text-sm text-gray-500 sm:mx-auto">
            Size kılıcınızı bırakıp kazananlara katılmalarını söylüyorlar. 22
            yılda tek 'kazananlar'
          </p>
        </div>
        <div className="relative text-center">
          <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-indigo-50 sm:w-20 sm:h-20">
          ...
          <h6 className="mb-2 text-2xl font-extrabold text-[#4338ca]">Hızlı</h6>
          <p className="max-w-md mb-3 text-sm text-gray-500 sm:mx-auto">
            Onlara onları sevmediğimi söyle. Uzay Papanın sürüngen olduğunu mu?
            Ona zayıf göründüğünü söyle. Merhaba, küçük adam
          </p>
        </div>
      </div>
    </div>
