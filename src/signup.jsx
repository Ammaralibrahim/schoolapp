          ...
          <div className="mt-8 flex flex-col items-center">
            ...
            <div className="w-full flex-1 mt-4">
              <div className="mx-auto max-w-md">
                <input
                  className="w-full px-4 sm:px-8 py-3 sm:py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-xs sm:text-sm focus:outline-none focus:border-gray-400 focus:bg-white"
                  type="text"
                  placeholder="İsim"
                />
                <input
                  className="w-full px-4 sm:px-8 py-3 sm:py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-xs sm:text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-3 sm:mt-3"
                  type="text"
                  placeholder="Soyisim"
                />
                <input
                ...
                />
                <input
                  className="w-full px-4 sm:px-8 py-3 sm:py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-xs sm:text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-3 sm:mt-5"
                  type="password"
                  placeholder="Şifre"
                />
                <button className="mt-5 sm:mt-3 tracking-wide font-semibold bg-1e90ff text-gray-100 w-full py-3 sm:py-3 rounded-lg bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                  <SignupIcon />
                  <span className="ml-2">Kaydol</span>
                </button>
                <div className="float-right text-xs flex py-2">
                  Hesabınmı var?
                  <Link to="/login" className="ml-1 text-sky-600 underline">
                    Giriş yap
                  </Link>
                </div>
              </div>
